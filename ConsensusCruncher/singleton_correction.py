...
def duplex_consensus(read1, read2):
    ...
    return consensus_seq, consensus_qual, a, b
        ...
        for readPair in list(singleton_csn_pair.keys()):
            for tag in singleton_csn_pair[readPair]:
                ...
                if duplex in sscs_dict.keys():
                    ...
                    base_number = base_number + corrected_read[1] + corrected_read[2]
                    base_N += corrected_read[2]
                    sscs_correction_bam.write(corrected_read[0])
                ...
                # 2) Singleton correction by complementary Singletons
                    ...
                    base_number = base_number + corrected_read[1] + corrected_read[2]
                    base_N += corrected_read[2]
                    singleton_correction_bam.write(corrected_read[0])
...
base number : {}
base num N : {}
Uncorrected Singletons: {} \n'''.format(counter, sscs_dup_correction, sscs_correction_frac, singleton_dup_correction, singleton_correction_frac, base_number, base_N, uncorrected_singleton)
